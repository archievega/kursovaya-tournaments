...
Revision ID: 11024308efba
Revises: 2b6da7114323
Create Date: 2024-05-16 21:01:38.023511
...
revision: str = '11024308efba'
down_revision: Union[str, None] = '2b6da7114323'
...
def upgrade() -> None:
    ...
    sa.Column('scores', sa.INTEGER(), server_default='0', nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('starts_at', postgresql.TIMESTAMP(), nullable=False),
    sa.Column('max_players', sa.INTEGER(), nullable=False),
    sa.Column('address', sa.TEXT(), nullable=False),
    sa.Column('winner_id', GUID(), nullable=True),
    sa.Column('status', postgresql.ENUM('WAITING', 'RUNNING', 'ENDED', name='tournament_status', create_type=False), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('WAITING', 'ACCEPTED', 'DECLINED', 'BANNED', name='player_status', create_type=False), nullable=False),
